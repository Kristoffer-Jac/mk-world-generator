...
<title>Mario Kart World – Slumpgenerator</title>
<style>
  :root {
  ...
  * { box-sizing: border-box; }
  ...
  body { font-family: ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial; background: #f6f8ff; color: var(--text); }
...
// —— Default icons autoload (with file:// fallback) ——
  ...
  try {
    ...
    if (custom) {
      ...
      if (location.protocol !== "file:") {
        ...
        if (auto) {
          if (!silent) alert("Välj din mk_world_icons.json – webbläsaren blockerar automatisk läsning i file://-läge.");
          auto.onchange = (e) => {
